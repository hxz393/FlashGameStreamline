"""
本文件定义了一个关于对话框的类 `DialogAbout`，用于在 PyQt5 框架中显示关于程序的信息。该类包括初始化界面、更新语言设置、创建顶部、中间、底部区域等方法。通过这些方法，可以构建一个包含程序信息、版本号、作者信息等的对话框。
...
class DialogAbout(QDialog):
    ...
    def _clickable_image() -> QLabel:
        ...
        # 加载 ICO 文件并调整大小
        icon = QIcon(get_resource_path("media/main.ico"))
        pixmap = icon.pixmap(96, 96)  # 直接从 QIcon 获取指定大小的 QPixmap
